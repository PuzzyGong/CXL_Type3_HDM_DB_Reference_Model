    ...
    Rd_Addr_Type &rd_addr)
{
    if (state == Idle)
    {
        if (m2s_req.valid)
        {
            ...
            {
                CPP_WARNING("vsf: Unknown SnpType/MemOpcode/MetaField/MetaValue in M2S_Req");
            }
        }
        else
        {
    ...
    if (state == Wait_For_Rsp)
    {
        if (m2s_rsp.valid)
        {
            if (m2s_rsp.opcode == M2S_Rsp_type::Opcode_Enum::BIRspI)
            {
                ...
                {
                    CPP_WARNING("vsf: Wrong Opcode in M2S_Rsp");
                }
            }
            ...
            {
                CPP_WARNING("vsf: Unknown Opcode in M2S_Rsp");
            }
        }
