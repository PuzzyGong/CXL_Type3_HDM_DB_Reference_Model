...
/*
    ...
    二、C++ Reference Model 软件中有哪些接口/字段 ？
        ...
        各接口/字段在 port.h 中以 class 成员的方式被罗列。"C++ Reference Model 软件接口/字段" 是 "CXL Type3 HDM-DB
   硬件接口/字段"的子集。
...
class S2M_Snp_type
{
  public:
    ...
    S2M_Snp_type()
        : valid(false), opcode(0), bi_id(0), bitag(0), address_partity(0), address(0), flit_mode(0), epoch_valid(0), epoch_id(0),
          cmd_parity(0), spid(0), dpid(0)
    {
    }
...
class S2M_NDR_Type
{
  public:
    ...
    S2M_NDR_Type()
        : valid(false), opcode(0), metafield(0), metavalue(0), tag(0), ld_id(0), devload(0), flit_mode(0), epoch_valid(0),
          epoch_id(0), cmd_parity(0), spid(0), dpid(0)
    {
    }
...
class S2M_DRS_Type
{
  public:
    ...
    u32 metafield;                              //  2bit
    u32 metavalue;                              //  2bit
    u32 extended_metadata;                      // 32bit (inhouse)
    u32 tag;                                    // 16bit
    u32 ld_id;                                  //  4bit
    /*                */ u32 devload;           //  2bit
    u32 flit_mode;                              //  2bit
    ...
    S2M_DRS_Type()
        : valid(false), opcode(0), metafield(0), metavalue(0), extended_metadata(0), tag(0), ld_id(0), devload(0), flit_mode(0),
          epoch_valid(0), epoch_id(0), cmd_parity(0), spid(0), dpid(0), data_poison(0), data_byte_enable(0)
    {
    }
...
class M2S_Req_Type
{
  public:
    ...
    M2S_Req_Type()
        : valid(false), memopcode(0), snptype(0), metafield(0), metavalue(0), tag(0), tc(0), address5(0), address_partity(0),
          address(0), ld_id(0), flit_mode(0), cmd_parity(0), spid(0), dpid(0)
    {
    }
...
class M2S_RwD_Type
{
  public:
    ...
    M2S_RwD_Type()
        : valid(false), memopcode(0), snptype(0), metafield(0), metavalue(0), tag(0), tc(0), address_partity(0), address(0),
          ld_id(0), flit_mode(0), cmd_parity(0), spid(0), dpid(0), data_poison(0), data_byte_enable(0), data_body(0)
    {
    }
...
class s_axi_lite_rd_addr_Type
{
    public:
    bool valid;
    u32 address;
};
class s_axi_lite_wr_Type
{
    public:
    bool valid;
    u32 address;
